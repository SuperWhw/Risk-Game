...
public class TestClientController {
    public static void main(String[] args) {
        ...
        // create territories
        Territory Narnia = new Territory("Narnia", "N",10, 5, 5, 5,p1);
        Territory Midkemia = new Territory("Midkemia", "Mi",12, 5, 5,5, p1);
        Territory Oz = new Territory("Oz", "O", 8, 5,5,5, p1);
        Territory Elantris = new Territory("Elantris", "E",6, 5, 5, 5, p2);
        Territory Scadrial = new Territory("Scadrial", "S",5, 5, 5, 5, p2);
        Territory Roshar = new Territory("Roshar", "R",3, 5, 5, 5, p2);
        Territory Gondor = new Territory("Gondor", "G",13, 5, 5, 5, p3);
        Territory Mordor = new Territory("Mordor", "Mo",14, 5, 5, 5, p3);
        Territory Hogwarts = new Territory("Hogwarts", "H",3, 5, 5, 5, p3);
        ...
        while(true) {
            try {
                ...
                Order order = gsu.strToOrder(map, in, p1);
